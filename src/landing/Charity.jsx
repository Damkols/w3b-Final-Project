      ...
      <div className="container flex flex-col-reverse mx-auto lg:flex-row">
        <div className="flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 dark:bg-violet-400 dark:text-gray-900">
          <div className="flex space-x-2 sm:space-x-4">
            ...
            <IoCheckmarkCircle color="#91be55" fontSize={50} />

            <div className="space-y-2">
              <p className="text-lg font-medium leadi">Charity For Water</p>
              <p className="leadi">
          ...
          <div className="flex space-x-2 sm:space-x-4">
            ...
            <IoCheckmarkCircle color="#91be55" fontSize={50} />
            <div className="space-y-2">
              <p className="text-lg font-medium leadi">Charity For Food</p>
              <p className="leadi">
                Praesentium ea et neque distinctio quas eius repudiandae quaerat
                obcaecati voluptatem similique!
              </p>
          ...
          <div className="flex space-x-2 sm:space-x-4">
            ...
            <IoCheckmarkCircle color="#91be55" fontSize={50} />
            <div className="space-y-2">
              <p className="text-lg font-medium leadi">Charity For Climate</p>
              <p className="leadi">
                Praesentium ea et neque distinctio quas eius repudiandae quaerat
                obcaecati voluptatem similique!
              </p>
